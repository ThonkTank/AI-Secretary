...
public class CookingPreferencesRowMapper implements RowMapper<CookingPreferences> {
    ...
    public Map<String, Object> toRow(CookingPreferences preferences) {
        ...
        // Serialize all meal type preferences
        MealTypeFields.serializeMaxCooking(row, preferences);
        MealTypeFields.serializeCookingDays(row, preferences);
    ...
    public CookingPreferences fromRow(Map<String, Object> row) {
        ...
        // Deserialize all meal type preferences
        MealTypeFields.deserializeMaxCooking(row, preferences);
        MealTypeFields.deserializeCookingDays(row, preferences);
    ...
    /**
     * Helper class to manage the 4 meal type field pairs (max*Cooking and *CookingDays),
     * eliminating repetitive serialization/deserialization code.
     */
    private static class MealTypeFields {
        static void serializeMaxCooking(Map<String, Object> row, CookingPreferences preferences) {
        ...
        static void serializeCookingDays(Map<String, Object> row, CookingPreferences preferences) {
        ...
        static void deserializeMaxCooking(Map<String, Object> row, CookingPreferences preferences) {
        ...
        static void deserializeCookingDays(Map<String, Object> row, CookingPreferences preferences) {
