...
public class TaskEditFormViews {
    ...
    public final EditText minDurationView, maxDurationView, cooldownView, budgetRequirementCentsView;
    ...
    public TaskEditFormViews(EditText titleView, EditText minDurationView, EditText maxDurationView,
                             EditText cooldownView, EditText budgetRequirementCentsView, CheckBox toggleRepetition, EditText repsView,
        ...
        this.cooldownView = cooldownView; this.budgetRequirementCentsView = budgetRequirementCentsView; this.toggleRepetition = toggleRepetition;
