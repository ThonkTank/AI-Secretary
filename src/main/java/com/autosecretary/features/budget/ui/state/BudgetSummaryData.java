 ...
 * or negative (overdraft). See {@link LoadBudgetOverviewUseCase}.
 */
public record BudgetSummaryData(long incomeCents, long expenseCents, long freeBudgetCents) implements UiStateCarrier {
