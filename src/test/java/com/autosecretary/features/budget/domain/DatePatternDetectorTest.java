...
public class DatePatternDetectorTest {
    ...
    public void detectDatePattern_detectsMonthlyDayAcrossMonthBoundaries() {
        ...
        Assert.assertEquals(RecurringBudgetTransaction.RecurringType.MONTHLY_DAY, result.type());
    }
    ...
    public void detectDatePattern_detectsMonthlyLastOnShortAndLongMonths() {
        ...
        Assert.assertNotNull(result);
        Assert.assertEquals(RecurringBudgetTransaction.RecurringType.MONTHLY_LAST, result.type());
    }
    ...
    public void detectDatePattern_detectsWeeklyWithOneOutlier() {
        ...
        Assert.assertNotNull(result);
        Assert.assertEquals(RecurringBudgetTransaction.RecurringType.WEEKLY, result.type());
    ...
    public void detectDatePattern_detectsConsistentInterval() {
        ...
        Assert.assertNotNull(result);
        Assert.assertEquals(RecurringBudgetTransaction.RecurringType.INTERVAL, result.type());
        Assert.assertEquals(14, result.value());
    }

    private RecurringBudgetTransaction tx(LocalDate date) {
        return new RecurringBudgetTransaction.Builder(10L, -1200, date, 5L)
                .payee("DATE TEST")
                .build();
    }
}
