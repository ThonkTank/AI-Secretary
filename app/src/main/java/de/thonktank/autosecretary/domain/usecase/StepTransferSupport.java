...
final class StepTransferSupport {
    ...
    static Task active(TaskRepository repository, TaskId id) {
    ...
    static boolean canonicalSnapshots(TaskRepository repository, TaskId taskId) {
    ...
    static boolean resequenceOpen(TaskRepository repository, TaskId taskId) {
    ...
    static OccurrenceStep snapshot(TaskRepository repository, String occurrenceId,
                                   String templateId) {
    ...
    static void reparentCombo(TaskRepository repository, String templateId, TaskId taskId) {
