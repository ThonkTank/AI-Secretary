...
public final class UiCommand {
    public enum Kind { REFRESH, CREATE, UPDATE, MOVE, DELETE, LOAD_EDITOR, COMPLETE,
        ...
        CORRECT_REPETITION_RESULT, FINISH_STEP, ADVANCE_TODAY_STEP, MOVE_TODAY_STEP,
        DEFER, CLOSE, ORGANIZE, TRAINING_ASSISTANT }
    ...
    public RewardAnchorKey rewardAnchor() {
        ...
        switch (kind) {
            ...
            case FINISH_STEP: case ADVANCE_TODAY_STEP:
