...
public final class AllTasksFilter {
    ...
    public AllTasksFilter withQuery(String value) {
        return copy(value, status, slots, recurrences, weekday);
    }
    public AllTasksFilter withStatus(AllTasksUiState.Status value) {
        return copy(query, value, slots, recurrences, weekday);
    }
    public AllTasksFilter withSlots(Set<TaskSlot> value) {
        return copy(query, status, value, recurrences, weekday);
    }
    public AllTasksFilter withRecurrences(Set<Recurrence> value) {
        return copy(query, status, slots, value, weekday);
    }
    public AllTasksFilter withWeekday(int value) {
        return copy(query, status, slots, recurrences, value);
    }
    ...
    private AllTasksFilter copy(String query, AllTasksUiState.Status status,
        ...
        return new AllTasksFilter(query, status, slots, recurrences, weekday);
    }
    ...
    @Override public boolean equals(Object other) {
        ...
        if (!(other instanceof AllTasksFilter)) return false;
        AllTasksFilter value = (AllTasksFilter) other;
        return weekday == value.weekday && query.equals(value.query) && status == value.status
                && slots.equals(value.slots) && recurrences.equals(value.recurrences);
    }

    @Override public int hashCode() {
        return Objects.hash(query, status, slots, recurrences, weekday);
    }
}
