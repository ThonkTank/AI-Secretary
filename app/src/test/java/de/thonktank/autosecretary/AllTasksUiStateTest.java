...
public final class AllTasksUiStateTest {
    ...
    private static TaskCatalog catalog() {
        Task gym = Task.restore(TaskId.of("gym"), "Gym", TaskSlot.MORNING,
                Recurrence.DAILY, 1, 0, false, "", false, false, MONDAY,
                null, null, 1_024, false, 45, 1 | 4,
                de.thonktank.autosecretary.domain.model.TaskBoundKind.FOREVER,
                null, null, null, null, "Training");
        Task weekday = Task.restore(TaskId.of("weekday"), "Büro", TaskSlot.MIDDAY,
                Recurrence.WEEKDAYS, 1, 1, false, "", false, false, MONDAY,
                null, null, 2_048, false, null, 2,
                de.thonktank.autosecretary.domain.model.TaskBoundKind.FOREVER,
                null, null, null, null, "");
        Task archived = Task.restore(TaskId.of("archive"), "Alt", TaskSlot.LATER,
                Recurrence.ONCE, 1, 0, false, "", false, true, null,
                MONDAY, MONDAY, 3_072, true, null, 0,
                de.thonktank.autosecretary.domain.model.TaskBoundKind.FOREVER,
                null, null, null, null, "");
