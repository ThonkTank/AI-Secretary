...
final class DashboardFixtures {
    ...
    static TaskSnapshot simpleTask() {
        return task("simple", "Brief beantworten", TaskSlots.MORNING, "ONCE",
                Collections.emptyList(), 0, false, false, false, false, 0, 1_001_000L);
    }

    static TaskSnapshot taskWithSteps() {
        return task("steps", "Morgenroutine", TaskSlots.MORNING, "DAILY",
                Arrays.asList(
    ...
    private static TaskSnapshot task(String id, String title, String slot, String recurrence,
