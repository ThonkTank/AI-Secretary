...
public final class DaylightBackdropView extends View {
    ...
    private LocalDate currentDate = LocalDate.of(2000, 1, 1);
    private LocalTime currentTime = LocalTime.NOON;
    ...
    public void setTime(LocalDateTime time, ZoneId zone) {
        if (time == null || zone == null) return;
    ...
    public boolean wantsLightCards() {
        ...
        SolarDaylight.Window window = SolarDaylight.forDate(
                currentDate, latitude, longitude, currentZone);
        return window.isLight(currentTime);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Scene scene = sceneAt(currentDate, currentTime, latitude, longitude, currentZone);
