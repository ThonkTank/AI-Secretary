 ...
 * {@link TaskEditSessionController} is created inside {@link #create} rather than injected because
 * it is ViewModel-scoped: it must be recreated each time a new {@link TaskViewModel} instance is
 * created and must not be shared across ViewModel instances.
 */
